          ...
          <ul>
            ...
            <li className="py-1">Copyrights</li>
              ...
              <div className='col-span-2 pt-8 md:pt-2'>
                  <p className='font-bold uppercase'>Subscribe to the Digital Building Monthly Tips and Tricks</p>
                  <p className='py-4'>Get monthly information on new resources and Application notes sent to your inbox.</p>
                  <form className='flex flex-col sm:flex-row'>
                      <input className='w-full p-2 mr-4 rounded-mb mb-4' type="email" />
